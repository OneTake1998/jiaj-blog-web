...
export default {
  ...
  computed: {
    cssVariables() {
      return `
          --aurora-dia--linear-gradient: ${this.$store.state.themeConfig.theme.header_gradient_css};
          --aurora-dia--linear-gradient-hover: linear-gradient(
            to bottom,
            ${this.$store.state.themeConfig.theme.gradient.color_2},
            ${this.$store.state.themeConfig.theme.gradient.color_3}
          );
          --aurora-dia--platform-light: ${this.$store.state.themeConfig.theme.gradient.color_3};
        `;
    },
  },
};
